...
export const projects = [
  ...
  {
    name: 'CSSART.CLUB',
    description: 'A collection of subtly interactive digital paintings made with HTML and CSS.',
  ...
  {
    name: 'Monique',
    description: 'Monique is a bot that responds to voice commands. She aspires to be like Alexa one day.',
    preview_img: '',
